                ...
                <View style={{ paddingTop: '5%', padding: '5%', }}>
                    <View style={style.homee}>
                        ...
                        <View style={{ position: 'absolute', }}>
                            <Image style={{ left: '40%', top: '25%', position: 'absolute' }} source={require('../image/Line40.png')} />
                    ...
                    <View style={style.homebuy}>
                        <Image style={style.reangle62} source={require('../image/Rectangle62.png')} />
                        <View style={{ position: 'absolute', }}>
                            <Image style={{ left: '56%', top: '25%', position: 'absolute' }} source={require('../image/Line40.png')} />
